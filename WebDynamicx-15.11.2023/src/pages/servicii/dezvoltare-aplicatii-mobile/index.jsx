  ...
  render() {
    return (
      <React.Fragment>
        <Head>
          <title>
            Dezvoltare aplicatii de mobil iOS si Android - Web App Dynamicx
          </title>
          <meta
            name="description"
            content={
              "Ca o companie specializată în dezvoltarea de aplicații mobile, oferim servicii de creare a aplicațiilor mobile utilizând acest cunoscut framework JavaScript, destinat construirii de aplicații mobile native."
            }
          />
          <meta
            name="og:title"
                    ...
                    <div className="row sercice-details-content align-items-center">
                      <div className="col-lg-6 col-12 order-2 order-lg-1">
                        <div className="details mt_md--30 mt_sm--30">
                          ...
                          <h4 className="title">Dezvoltare Aplicații Mobile</h4>
                          <p>
                          ...
                          <p>
                            ...
                            mobile, oferim servicii de dezvoltare utilizând un
                            framework JavaScript pentru a crea aplicații mobile
                            native eficiente și performante.
                          </p>
                        </div>
                      </div>
