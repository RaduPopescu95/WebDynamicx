...
const blocksData = [
  {
    ...
    content:
      "Oferim servicii de cea mai înaltă calitate, adaptate nevoilor tale specifice, pentru a asigura succesul proiectelor tale.",
    dataAos: "fade-up",
    dataAosDelay: "",
  },
  {
    ...
    title: "Suport 24x7",
    content:
      "Echipa noastră este disponibilă non-stop pentru a-ți oferi suport tehnic și consultanță, indiferent de oră sau zi.",
    dataAos: "fade-up",
    dataAosDelay: "100",
  },
  {
    ...
    content:
      "Îți oferim soluții de dezvoltare la prețuri competitive, fără a compromite calitatea sau performanța.",
    dataAos: "fade-up",
    dataAosDelay: "200",
  },
  {
    ...
    content:
      "Construim parteneriate de lungă durată, bazate pe încredere și transparență, asigurându-ne că fiecare client este pe deplin mulțumit.",
    dataAos: "fade-up",
    dataAosDelay: "300",
  },
