...
export const pagesItems = [
  ...
  },
  {
    title: "Servicii",
    subItems: [
      { title: "Aplicatie mobila", link: "/pages-menu/service-v4" },
      { title: "Creare site web", link: "/pages-menu/service-v4" },
      { title: "Logo design", link: "/pages-menu/service-v4" },
      { title: "Magazin online", link: "/pages-menu/service-v4" },
      { title: "Domeniu si gazduire", link: "/pages-menu/service-v4" },
...

  {
    title: "Preturi",
    subItems: [
      { title: "Magazine online", link: "/pages-menu/pricing" },
      {
        title: "Aplicatii mobile pentru programari",
        link: "/pages-menu/pricing-v2",
      },
      { title: "Aplicatie mobila dedicata", link: "/pages-menu/pricing-v3" },
    ],
  },
  // {
  //   title: "Features",
